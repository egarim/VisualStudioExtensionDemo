...
namespace VisualStudioExtensionDemo
{
    ...
    internal sealed class LaunchWizardCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LaunchWizardCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in LaunchWizardCommand's constructor requires
            // the UI thread.
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            if (result == true)
            {
                ...
                // You can access wizardWindow.DataContext to get the view model data
            }
        }
    }
}
